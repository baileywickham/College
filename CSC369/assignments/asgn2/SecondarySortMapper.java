...
public class SecondarySortMapper 
    extends Mapper<LongWritable, Text, CGrade, Text> {
    @Override
    /**
    ...
    public void map(LongWritable key, Text value, Context context) 
        ...
        context.write(new CGRade(tokens[0].trim(), tokens[1].trim(), tokens[2].trim, tokens[3].trim()), new Text("(" + tokens[2] + ", " + tokens[3] ")"));
    }
}
