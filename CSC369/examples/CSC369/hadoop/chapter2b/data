 ...
 * Description:
 *
 * WordCountDriver: submits the job to Hadoop Counting the words if their size
 * is greater than or equal N, where N > 1.
 *
...
public class WordCountDriver extends Configured implements Tool {
    ...
    /**
     * Arguments are: args[0] = N (as integer) args[1] = input path args[2] =
     * output path
     */
