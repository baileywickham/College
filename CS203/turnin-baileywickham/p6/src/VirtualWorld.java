...
public final class VirtualWorld
{
    ...
    public final static List<Tile> dukeTiles;
    public final static List<Tile> superMinerTiles;
    ...
    static
    {
        ...
        dukeTiles = loadImages("duke", "^%");
        superMinerTiles = loadImages("superMiner", "S");
    }
    ...
    public VirtualWorld(double timeScale)
    {
        ...
        window.setFps(30f);
        window.setMouseClickedHandler(this::clicked);
    ...
    private void createInitialEntities() {
        ...
        addInitial(new MinerNotFull(new Point(12,23), 954,  300, 2));
        addInitial(new MinerNotFull(new Point(17,22), 982,310, 2));
        addInitial(new MinerNotFull(new Point(23,6), 777,320, 2));
        addInitial(new MinerNotFull(new Point(24,26), 851,90, 2));
        addInitial(new MinerNotFull(new Point(31,15), 933,95, 2));
        addInitial(new MinerNotFull(new Point(31,26), 734,87, 2));
        addInitial(new MinerNotFull(new Point(37,10), 400,33, 2));
        addInitial(new MinerNotFull(new Point(37,18), 888,100, 2));
        addInitial(new MinerNotFull(new Point(37,6), 991,317, 2));
        addInitial(new MinerNotFull(new Point(5,6), 992,318, 2));
        addInitial(new MinerNotFull(new Point(6,25), 930,106, 2));
        addInitial(new MinerNotFull(new Point(6,3), 813,92, 2));
        addInitial(new MinerNotFull(new Point(7,13),913, 97, 2));
    ...
    private void clicked (final int x, final int y) {
        Point p = new Point(x,y);
        eventSchedule.scheduleEvent(model,new Landing(p, model) , 0  );
    }
