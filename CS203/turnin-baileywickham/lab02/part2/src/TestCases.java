...
public class TestCases
{
    ...
    {
        assertEquals(1.0, new Point(1.0, 1.0).getX(), DELTA);
    }
    ...
    {
        assertEquals(0, new Point(1,0).getAngle(), DELTA);
    }
    private void testGetRotate()
    {
        Point p = new Point(-1,0);
        assertEquals(p.getX(), new Point(0,1).rotate90().getX(), DELTA);
    }
